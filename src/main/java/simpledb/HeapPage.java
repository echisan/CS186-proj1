...
public class HeapPage implements Page {
    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
        ...
        // 根据tupleDesc算出每一行记录占用多少bit
        // 然后再处以每一页大小，可以得出一页总共能放多少行记录
        this.numSlots = getNumTuples();
        DataInputStream dis = new DataInputStream(new ByteArrayInputStream(data));

        // allocate and read the header slots of this page
        // 一个header占用1个比特，一页有numSlots个tuple
    ...
    private int getNumTuples() {
        ...
        // Each file consists of page data arranged consecutively on disk. Each page consists of one or
        //more bytes representing the header, followed by the BufferPool.PAGE_SIZE - # header bytes bytes
        //of actual page content. Each tuple requires tuple size * 8 bits for its content and 1 bit for the header.
        //Thus, the number of tuples that can fit in a single page is:
        //
